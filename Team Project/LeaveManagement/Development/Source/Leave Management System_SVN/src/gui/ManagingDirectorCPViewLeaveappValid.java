...
public class ManagingDirectorCPViewLeaveappValid extends JFrame {
	 ...
	 */
	public ManagingDirectorCPViewLeaveappValid() {
		super();
		initialize();
	}
		...
		if (mniCreateLA == null) {
			...
			mniCreateLA.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new CreateLeaveapp(new ManagingDirectorCPViewLeaveappValid()).setVisible(true);
				}
			});
		}
		return mniCreateLA;
	...
	private JMenuItem getMniAbout() {
		if (mniAbout == null) {
			...
			mniAbout.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new About(new ManagingDirectorCPViewLeaveappValid()).setVisible(true);
				}
			});
		}
		return mniAbout;
	...
	private JMenuItem getMniEditpassword() {
		if (mniEditpassword == null) {
			...
			mniEditpassword.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new Changepassword(new ManagingDirectorCPViewLeaveappValid()).setVisible(true);
				}
			});
		}
	...
	private JMenuItem getMniEditProfile() {
		if (mniEditProfile == null) {
			...
			mniEditProfile.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new Editprofile(new ManagingDirectorCPViewLeaveappValid()).setVisible(true);
				}
			});
		}
	...
	private JMenuItem getMniAdduser() {
		if (mniAdduser == null) {
			...
			mniAdduser.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new Addmember(new ManagingDirectorCPViewLeaveappValid()).setVisible(true);
				}
			});
		}
		return mniAdduser;
	...
	private JButton getBtnExit() {
		if (btnExit == null) {
			...
			btnExit.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					ManagingDirectorCPViewLeaveappValid.this.dispose();
				}
			});
		}
		return btnExit;
