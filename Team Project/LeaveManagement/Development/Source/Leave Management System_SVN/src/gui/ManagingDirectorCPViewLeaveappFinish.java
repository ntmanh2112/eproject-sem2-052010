...
public class ManagingDirectorCPViewLeaveappFinish extends JFrame {
	 ...
	 */
	public ManagingDirectorCPViewLeaveappFinish() {
		super();
		initialize();
	}
		...
		if (mniCreateLA == null) {
			...
			mniCreateLA.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new CreateLeaveapp(new ManagingDirectorCPViewLeaveappFinish()).setVisible(true);
				}
			});
		}
		return mniCreateLA;
		...
		if (mniReportmonth == null) {
			...
			mniReportmonth.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					ManagingDirectorCPViewLeaveappFinish.this.dispose();
				}
			});
		}
	...
	private JMenuItem getMniLeaveAP() {
		if (mniLeaveAP == null) {
			...
			mniLeaveAP.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new ManagingDirectorCPViewLeaveappFinish().setVisible(true);
					ManagingDirectorCPViewLeaveappFinish.this.dispose();
				}
			});
		}
	...
	private JMenuItem getMniAbout() {
		if (mniAbout == null) {
			...
			mniAbout.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new About(new ManagingDirectorCPViewLeaveappFinish()).setVisible(true);
				}
			});
		}
		return mniAbout;
	...
	private JMenuItem getMniEditpassword() {
		if (mniEditpassword == null) {
			...
			mniEditpassword.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new Changepassword(new ManagingDirectorCPViewLeaveappFinish()).setVisible(true);
				}
			});
		}
	...
	private JMenuItem getMniEditProfile() {
		if (mniEditProfile == null) {
			...
			mniEditProfile.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new Editprofile(new ManagingDirectorCPViewLeaveappFinish()).setVisible(true);
				}
			});
		}
	...
	private JMenuItem getMniAdduser() {
		if (mniAdduser == null) {
			...
			mniAdduser.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new Addmember(new ManagingDirectorCPViewLeaveappFinish()).setVisible(true);
				}
			});
		}
		return mniAdduser;
