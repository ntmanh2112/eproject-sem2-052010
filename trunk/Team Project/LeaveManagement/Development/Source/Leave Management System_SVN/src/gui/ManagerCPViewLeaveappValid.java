...
public class ManagerCPViewLeaveappValid extends JFrame {
	 ...
	 */
	public ManagerCPViewLeaveappValid() {
		super();
		initialize();
	}
		...
		if (mniCreateLA == null) {
			...
			mniCreateLA.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new CreateLeaveapp(new ManagerCPViewLeaveappValid()).setVisible(true);
				}
			});
		}
		return mniCreateLA;
	...
	private JMenuItem getMniLeaveAP() {
		if (mniLeaveAP == null) {
			...
			mniLeaveAP.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new ManagerCPViewLeaveappValid().setVisible(true);
	...
	private JMenuItem getMniAbout() {
		if (mniAbout == null) {
			...
			mniAbout.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new About(new ManagerCPViewLeaveappValid()).setVisible(true);
				}
			});
		}
		return mniAbout;
	...
	private JMenuItem getMniEditpassword() {
		if (mniEditpassword == null) {
			...
			mniEditpassword.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new Changepassword(new ManagerCPViewLeaveappValid()).setVisible(true);
				}
			});
		}
	...
	private JMenuItem getMniEditProfile() {
		if (mniEditProfile == null) {
			...
			mniEditProfile.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new Editprofile(new ManagerCPViewLeaveappValid()).setVisible(true);
				}
			});
		}
	...
	private JMenuItem getMniAdduser() {
		if (mniAdduser == null) {
			...
			mniAdduser.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new Addmember(new ManagerCPViewLeaveappValid()).setVisible(true);
				}
			});
		}
		return mniAdduser;
	...
	private JButton getBtnExit() {
		if (btnExit == null) {
			...
			btnExit.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					ManagerCPViewLeaveappValid.this.dispose();
				}
			});
		}
		return btnExit;
